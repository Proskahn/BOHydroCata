...
async def test_create_experiment(dependencies, monkeypatch, tmp_path):
    ...
    response = client.post("/api/v1/experiments", json={"name": "test_exp", "comments": "Anode catalyst with IrO2 and RuO2"})
    assert response.status_code == 200
    assert response.json() == {"name": "test_exp", "comments": "Anode catalyst with IrO2 and RuO2"}
...
async def test_add_variable(dependencies, monkeypatch, tmp_path):
    ...
    response = client.post("/api/v1/experiments/test_exp/variables", json={"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0})
    assert response.status_code == 200
    assert response.json() == {"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0}
...
async def test_add_objective(dependencies, monkeypatch, tmp_path):
    ...
    response = client.post("/api/v1/experiments/test_exp2/objectives", json={"name": "hydrogen production rate"})
    assert response.status_code == 200
...
async def test_record_experiment_result(dependencies, monkeypatch, tmp_path):
    ...
    client.post("/api/v1/experiments/test_exp3/variables", json={"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0})
    
    response = client.post("/api/v1/experiments/test_exp3/results", json={"x1": 0.5, "objective_value": 100.0})
    assert response.status_code == 200
...
async def test_delete_experiment_result(dependencies, monkeypatch, tmp_path):
    ...
    client.post("/api/v1/experiments/test_exp4/variables", json={"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0})
    client.post("/api/v1/experiments/test_exp4/results", json={"x1": 0.5, "objective_value": 100.0})
    
    response = client.get("/api/v1/experiments/test_exp4")
    assert response.status_code == 200
    assert {"x1": 0.5, "objective_value": 100.0} in response.json()["results"]
    
    response = client.request("DELETE", "/api/v1/experiments/test_exp4/results", json={"x1": 0.5})

    assert response.status_code == 200
    assert response.json().get("message") == "Result x1=0.5 deleted for experiment 'test_exp4'"
...
async def test_list_experiments(dependencies, monkeypatch, tmp_path):
    ...
    client.post("/api/v1/experiments", json={"name": "exp5", "comments": "Experiment 1"})
    client.post("/api/v1/experiments", json={"name": "exp6", "comments": "Experiment 2"})
...
async def test_recommend_next(dependencies, monkeypatch, tmp_path):
    ...
    client.post("/api/v1/experiments/test_exp7/variables", json={"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0})
    client.post("/api/v1/experiments/test_exp7/results", json={"x1": 0.3, "objective_value": 80.0})
    client.post("/api/v1/experiments/test_exp7/results", json={"x1": 0.7, "objective_value": 120.0})
...
async def test_get_experiment(dependencies, monkeypatch, tmp_path):
    ...
    client.post("/api/v1/experiments/test_exp8/variables", json={"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0})
    client.post("/api/v1/experiments/test_exp8/objectives", json={"name": "hydrogen production rate"})
    client.post("/api/v1/experiments/test_exp8/results", json={"x1": 0.5, "objective_value": 100.0})
    ...
    assert {"name": "ratio of IrO2", "lower_bound": 0.0, "upper_bound": 1.0} in data["variables"]
...
async def test_delete_experiment(dependencies, monkeypatch, tmp_path):
    ...
    client.post("/api/v1/experiments/test_exp9/results", json={"x1": 0.5, "objective_value": 100.0})
    ...
    try:
        ...
        logger.debug("Attempted cleanup of test_exp9 from test_delete_experiment (may already be deleted)")
    except Exception as e:
